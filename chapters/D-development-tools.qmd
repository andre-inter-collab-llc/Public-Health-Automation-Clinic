...
![Built with AI. Owned by You.](../assets/images/ai-transparency-graphic.png){fig-alt="Infographic showing the three-stage model: AI accelerates development, the solution is published as open source, and you run it locally with no AI required."}
...
::: {.callout-important title="Built with AI. Owned by You."}
...
## Recommended Software for Using This Resource
...
|:---------|:--------|:---------|
| **[R](https://cloud.r-project.org/)** | Core language for most solutions | [cloud.r-project.org](https://cloud.r-project.org/) |
...
|:-----|:--------|:---------|
| **[RStudio Desktop](https://posit.co/download/rstudio-desktop/)** | R-focused work; the most widely used IDE for R among public health professionals | [posit.co/download/rstudio-desktop](https://posit.co/download/rstudio-desktop/) |
| **[Positron](https://positron.posit.co/)** | A next-generation IDE from Posit with native support for both R and Python | [positron.posit.co](https://positron.posit.co/) |
| **[VS Code](https://code.visualstudio.com/)** | A general-purpose editor with R and Python support via extensions; ideal if you already use it for other work | [code.visualstudio.com](https://code.visualstudio.com/) |
...
| Software | Purpose | Download |
|:---------|:--------|:---------|
| **[Python](https://www.python.org/downloads/)** | Used in some solutions, particularly for data quality checks and file operations | [python.org/downloads](https://www.python.org/downloads/) |
| **[Quarto](https://quarto.org/docs/get-started/)** | Required for solutions that produce formatted reports or documents | [quarto.org/docs/get-started](https://quarto.org/docs/get-started/) |
| **[Git](https://git-scm.com/)** | Version control; useful for downloading and tracking updates to solutions | [git-scm.com](https://git-scm.com/) |
...
|:---------|:------------|
| **[Anthropic](https://www.anthropic.com/)** | Complex analysis, long-form content development |
| **[Google](https://deepmind.google/technologies/gemini/)** | Research, cross-referencing, fact-checking |
| **[OpenAI](https://openai.com/)** | Code generation, quick edits, formatting |

Specific models evolve frequently. For the current list of available models, see the [GitHub Copilot model comparison](https://docs.github.com/en/copilot/reference/ai-models/model-comparison).
...
If the Public Health Automation Clinic has been useful in your work, please consider citing it. A citation helps others discover the resource and supports the community of practice this project aims to build.

> André van Zyl, *Public Health Automation Clinic*, Intersect Collaborations LLC, 2025. Available at: <https://andre-inter-collab-llc.github.io/Public-Health-Automation-Clinic/>
